/**
 * FingerprintJS Server API Node.js SDK v5.0.0 - Copyright (c) FingerprintJS, Inc, 2024 (https://fingerprint.com)
 ...
 * @private
 * */
declare function getDeleteVisitorDataUrl(region: Region, visitorId: string, apiKey?: string): string;
/**
 * @private
 * */
...
export { ApiError, AuthenticationMode, CommonError429, type CommonResponse429, DELETE_VISITS_ERRORS, DecryptionAlgorithm, type DecryptionKey, DeleteVisit400Error, type DeleteVisit400Response, DeleteVisit403Error, type DeleteVisit403Response, DeleteVisit404Error, type DeleteVisit404Response, EVENT_ERRORS, EventError403, EventError404, type EventResponse, type EventResponse403, type EventResponse404, FingerprintJsServerApiClient, type IsValidWebhookSignatureParams, type Options, Region, SdkError, type TooManyRequestsError, UnsealAggregateError, UnsealError, VISITOR_ERRORS, type VisitWebhook, type VisitorHistoryFilter, type VisitorsError, VisitorsError403, VisitorsError429, type VisitorsResponse, type VisitorsResponse403, type VisitorsResponse429, getDeleteVisitorDataUrl, getEventUrl, getVisitorsUrl, isDeleteVisitorsError, isEventError, isValidWebhookSignature, isVisitorsError, parseEventsResponse, unseal, unsealEventsResponse };
